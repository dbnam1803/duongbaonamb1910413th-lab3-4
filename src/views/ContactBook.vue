    ...
    <div class="page row m-auto">
      ...
      <div class="mt-3 col-md-6">
        ...
        <div class="mt-3 row justify-content-around align-items-center">
          ...
          <button class="btn btn-sm btn-success" @click="goToAddContact"><i class="fas fa-plus"></i> Thêm mới</button>
          <button class="btn btn-sm btn-danger" @click="removeAllContacts"><i class="fas fa-trash"></i> Xóa tất cả</button>
        </div>
      </div>
      <div class="mt-3 col-md-6">
